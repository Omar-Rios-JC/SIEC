...
if (!$id) {
    header('Location: pacientes_inicio.php?error=ID no válido');
    exit;
}

$esp = Paciente::obtenerPorId($id);
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Editar - Días Paciente</title>
    <style>
        th,
        td {
    ...
    <div class="content">
        ...
        <div class="container mt-4">
            <div class="card p-4">
                ...
                <form method="POST" action="../../controladores/dias_pacientes.php">
