...
if (!$id) {
    header('Location: egresos_inicio.php?error=ID no válido');
    exit;
}

$esp = Egreso::obtenerPorId($id);
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="menuPrincipal">
                    ...
                    <ul class="dropdown-menu" data-bs-auto-close="outside">
                        ...
                        <li>
                            ...
                            <ul class="dropdown-submenu">
                                <li><a class="dropdown-item" href="./unidades_reportan.php">Unidades
                                        que reportan</a></li>
                                <li><a class="dropdown-item" href="#">Paramédicos</a>
                                </li>
                        ...
                        <!-- Urgencias -->
                        <li><a class="dropdown-item" href="../productividad/Urgencias.php">Urgencias</a></li>
            ...
            <div class="d-flex align-items-center gap-2">
                <a href="./egresos_inicio.php" class="btn btn btn-outline-light"><i class="bi bi-arrow-left"
                                                                                      title="Atrás"></i></a>
                <div class="dropdown">
...
<div class="content">
    ...
    <div class="container mt-4">
        <div class="card p-4">
            <h4 class="text-center">Editar Datos de Egresos</h4>
            <form method="POST" action="../../controladores/egresos.php">
                ...
                <div class="d-flex justify-content-center gap-2 mt-4">
                    <a href="./egresos_inicio.php" class="btn btn-outline-secondary">
