...
<head>
    ...
    <title>Ingresar datos | Egresos</title>
...
<body style="background-color: aliceblue;">
    ...
    <div class="content">
        ...
        <div class="container mt-4">
            <div class="card p-4">
                <h4 class="text-center">Ingresar datos - Egresos</h4>
                ...
                <?php endif; ?>
                <br>
                <form id="formEgreso" action="../../controladores/egresos.php" method="post">
    ...
    <script>
        ...
        $('#buscarClave').on('click', function() {
            ...
            $.ajax({
                type: 'GET',
                url: '../../controladores/buscarEgresoPorClave.php',
                data: {
                    clave: clave,
                    anio: anio
                },
