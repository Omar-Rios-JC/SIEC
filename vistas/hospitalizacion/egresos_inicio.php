...
----------------------------------- */
        table.table {
            ...
            /* espacio entre filas para dar efecto de "card" */
            width: 100%;
        ...
        /* Si usas DataTables, puedes mantener estilos similares */
...
----------------------------------- */
        ...
        .dataTable-search input:focus {
            ...
            outline: none;
            box-shadow: 0 0 8px rgba(214, 26, 26, 0.4);
        }

        .dataTable-selector {
            border-radius: 14px;
            padding: 8px 16px;
            border: 1.8px solid #2a5f11;
            background-color: #ffffff;
            font-weight: 600;
            color: #5f1111;
   ...
   ----------------------------------- */
        ...
        #btnGrafico {
            ...
            font-weight: 600;
            color: white;
            box-shadow: 0 4px 10px rgba(231, 132, 63, 0.4);
            transition: background-color 0.3s ease, transform 0.2s ease;
        }

        #btnGrafico:hover {
            background-color: #cf6f2f;
            transform: translateY(-2px);
            cursor: pointer;
        }

        /* Botón estilo DataTables o filtros - azul suave */
        .btn-light {
            background-color: #4a90e2;
        ...
        .btn-naranja {
            ...
            font-size: 0.95rem;
            border-radius: 10px;
            box-shadow: 0 4px 12px rgba(231, 132, 63, 0.4);
            transition: background-color 0.3s ease, transform 0.2s ease;
        }
        ...
        .btn-naranja-claro {
            ...
            font-size: 0.95rem;
            border-radius: 10px;
            box-shadow: 0 4px 10px rgba(243, 167, 104, 0.4);
            transition: background-color 0.3s ease, transform 0.2s ease;
        }
...
----------------------------------- */
        .section-header {
            border-left: 5px solid rgb(172, 29, 29);
            padding-left: 15px;
        }
...
<body style="background-color: aliceblue;">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="menuPrincipal">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a class="btn btn-outline-light" href="../usuario/egresos_user.php">Vista de usuario</a>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="../usuario/"><i class="fas fa-eye me-2"></i>Ver
                                    como Usuario</a></li>
        ...
        <div class="container my-4">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center my-3 gap-2">
                <div class="d-flex flex-wrap align-items-center gap-2">
                    <a href="./ingresar-egreso.php" class="btn btn-naranja">➕ Agregar manual</a>
                    <a href="./agregar-egreso.php" class="btn btn-naranja">📥 Cargar archivo</a>
                    <a href="./actualizar-egreso.php" class="btn btn-naranja"
                ...
                <div class="d-flex justify-content-center align-items-center gap-2">
                    <form id="formDescargarExcel" action="./descargar-excel_egreso.php" method="post" class="m-0">
                        ...
                        <button class="btn btn-naranja-claro" type="submit">🟩 Descargar Excel con gráfico</button>
                    </form>
                    <a id="btnDescargarGraficoPDF" class="btn btn-naranja-claro">📈 Descargar PDF</a>
                    <a id="btnDescargarImagenesCanvasUrgencias" class="btn btn-naranja-claro">🖼️ Descargar Imagen</a>
                    <button id="btnGrafico" class="btn btn-naranja-claro" onclick="toggleGraficos()">📊 Ver Gráficos</button>
                </div>
            </div>
            <hr>
            ...
            <div id="graficoCard" class="info-card" style="display: none;">
                ...
                <p id="mensajeSinDatosMensualDivision" style="display: none; color: red;"><strong>No hay datos ingresados.</strong>

                <h4>Gráfico de Total Anual</h4>
            ...
            <!-- Tabla -->
            <?php
            $urgencias = Egreso::listar();
            if (count($urgencias) > 0) { ?>
                <div class="card shadow-sm mt-5">
                    <div class="card-header">
                        <h5 class="mb-0">Tabla de Egresos</h5>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <div class="row mb-3 justify-content-end">
                                <div class="col-md-3 col-sm-6 d-flex align-items-center gap-2">
                                    ...
                                    <select id="filtroAnioTabla" class="form-select form-select-sm shadow-sm border border-secondary-subtle" multiple>
                                        <?php
                            ...
                            <table class="table table-bordered align-middle text-center" id="tabla-urgencias">
                                ...
                                <tbody>
                                    ...
                                    foreach ($urgencias as $u) { ?>
                                        <tr>
                                            ...
                                            $granTotal += $total;
                                            ?>
                                            <td style="background-color: #f8e6ed;"><strong><?= $total ?></strong></td>
                                            <td><?= htmlspecialchars($u['anio']) ?></td>
                                            <td>
                                                <a class="btn btn-light btn-sm" href="./editar-egresos.php?id=<?= base64_encode($u['id']) ?>">Editar</a>
                                            </td>
                                            <td>
                                                <a class="btn btn-light btn-sm" href="../../controladores/egresos.php?a=Eliminar&id=<?= base64_encode($u['id']) ?>" onclick="return confirm('¿Desea eliminar este registro?')">Eliminar</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                                ...
                                <tfoot id="tfootTotales" class="table-light">
                                    <tr style="background-color: #f4f9f4; font-weight: bold;">
                                        <td colspan="3" class="text-center align-middle">Total General</td>
                                        <?php foreach ($meses as $mes): ?>
                                            <td id="total-<?= $mes ?>" class="text-center align-middle">0</td>
                                        <?php endforeach; ?>
                                        <td style="background-color: #e2c8dd;" id="total-general" class="text-center align-middle">0</td>
                                        <td colspan="3"></td>
                                    </tr>
                                </tfoot>
    ...
    <script>
        ...
        function actualizarFiltrosDependientes() {
            ...
            const aniosDisponibles = [...new Set(
                todosLosDatos
                .filter(d =>
                    (!especialidadesSeleccionadas.length || especialidadesSeleccionadas.includes(d.especialidad.trim().toLowerCase())) &&
                    (!divisionesSeleccionadas.length || divisionesSeleccionadas.includes(d.division.trim().toLowerCase()))
                )
                .map(d => d.anio)
            )];
            ...
            especialidadesDisponibles.sort().forEach(e => {
                selEsp.append(new Option(e.charAt(0).toUpperCase() + e.slice(1), e, false, especialidadesSeleccionadas.includes(e)));
            });
            ...
            divisionesDisponibles.sort().forEach(d => {
                selDiv.append(new Option(d.charAt(0).toUpperCase() + d.slice(1), d, false, divisionesSeleccionadas.includes(d)));
            });
            ...
            graficoMensualDivision = new Chart(ctx, {
                ...
                options: {
                    ...
                    plugins: {
                        title: {
                            display: true,
                            text: 'Mensual por División y Año'
                        },
                        legend: {
                            position: 'top'
                        }
            ...
            graficoTotales = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: valores,
                        backgroundColor: etiquetas.map((et, i) => et === 'Total General' ? 'black' : colores[i % colores.length])
                    }]
                },
                options: {
                    responsive: true,
                    plugins: {
                        title: {
                            display: true,
                            text: 'Totales Anuales por División y Año'
                        },
                        legend: {
                            display: false
                        },
        ...
        function actualizarTotalesUrgencias() {
            ...
            datosVisibles.each(function(row) {
                meses.forEach((mes, i) => {
                    const valor = parseInt(row[i + 3]) || 0; // Los meses inician en la columna 3
                    totalesPorMes[mes] += valor;
                    granTotal += valor;
                });
            });
            ...
            meses.forEach((mes, i) => {
                $(`#total-${mes}`).text(totalesPorMes[mes]);
            });
    ...
    <script>
        document.querySelector('#formDescargarExcel button[type="submit"]').addEventListener('click', function(e) {
            ...
            const anio = getSelectedValues('selectAnio');
            const especialidad = getSelectedValues('selectEspecialidad');
            const division = getSelectedValues('selectDivision');
    ...
    <script>
        document.getElementById('btnDescargarGraficoPDF').addEventListener('click', async () => {
            ...
            pdf.save("grafico-tablas-Egresos.pdf");
    ...
    <script>
        document.getElementById('btnDescargarImagenesCanvasUrgencias').addEventListener('click', function() {
            exportarCanvasConFondo('graficoUrgencias', 'grafico_mensual_dias_paciente.png');
            exportarCanvasConFondo('graficoMensualDivision', 'grafico_mensual_dias_paciente.png');
            exportarCanvasConFondo('graficoTotales', 'grafico_anual_division_dias-paciente.png');
        });
