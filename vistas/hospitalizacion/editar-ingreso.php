...
if (!$id) {
    header('Location: ingresos_inicio.php?error=ID no válido');
    exit;
}

$esp = Ingreso::obtenerPorId($id);
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="content">
    ...
    <div class="container mt-4">
        <div class="card p-4">
            <h4 class="text-center">Editar Ingreso</h4>
            <form method="POST" action="../../controladores/ingresos.php">
                ...
                <div class="d-flex justify-content-center gap-2 mt-4">
                    <a href="./ingresos_inicio.php" class="btn btn-outline-secondary">
