...
----------------------------------- */
        ...
        /* Encabezado - amarillo mostaza oscuro */
        ...
        /* Cuerpo de la tabla - blanco con sombra dorada */
        table.table tbody tr {
            background-color: #fffbea;
            box-shadow: 0 4px 8px rgba(212, 160, 23, 0.15);
...
----------------------------------- */
   ...
   ----------------------------------- */
        ...
        /* Botones principales (Agregar, Cargar, Actualizar) */
        .btn-urgencia {
            background-color: #d4a017;
            /* Mostaza oscuro */
            color: #fff;
        ...
        .btn-urgencia:hover {
            background-color: #b58f11;
            /* Un poco más oscuro */
            transform: translateY(-1px);
            color: #fff;
        }

        /* Botones de exportación (Excel, PDF, Imagen) */
        .btn-success {
   ...
   <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #7a123a;">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="menuPrincipal">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a class="btn btn-outline-light" href="../usuario/ingresos_user.php">Vista de usuario</a>
        ...
        <div class="container my-4">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center my-3 gap-2">
                <div class="d-flex flex-wrap align-items-center gap-2">
                    <a href="./ingresar-ingreso.php" class="btn btn-urgencia">➕ Agregar manual</a>
                    <a href="./agregar-ingreso.php" class="btn btn-urgencia">📥 Cargar archivo</a>
                    <a href="./actualizar-ingreso.php" class="btn btn-urgencia"
                ...
                <div class="d-flex justify-content-center align-items-center gap-2">
                    <form id="formDescargarExcel" action="./descargar-excel_ingreso.php" method="post" class="m-0">
            ...
            <!-- Tabla -->
            <?php
            $urgencias = Ingreso::listar();
            if (count($urgencias) > 0) { ?>
                <div class="card shadow-sm mt-5">
                    <div class="card-header">
                        <h5 class="mb-0">Tabla de Ingresos</h5>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    foreach ($urgencias as $u) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-light btn-sm" href="./editar-ingreso.php?id=<?= base64_encode($u['id']) ?>">Editar</a>
                                            </td>
                                            <td>
                                                <a class="btn btn-light btn-sm" href="../../controladores/ingresos.php?a=Eliminar&id=<?= base64_encode($u['id']) ?>" onclick="return confirm('¿Desea eliminar este registro?')">Eliminar</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
    ...
    <script>
        document.getElementById('btnDescargarGraficoPDF').addEventListener('click', async () => {
            ...
            pdf.save("grafico-tablas-ingresos.pdf");
    ...
    <script>
        document.getElementById('btnDescargarImagenesCanvasUrgencias').addEventListener('click', function() {
            exportarCanvasConFondo('graficoUrgencias', 'grafico_mensual_ingresos.png');
            exportarCanvasConFondo('graficoMensualDivision', 'grafico_mensual_ingresos.png');
            exportarCanvasConFondo('graficoTotales', 'grafico_anual_division_ingresos.png');
        });
