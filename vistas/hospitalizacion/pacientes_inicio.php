...
----------------------------------- */
   ...
   ----------------------------------- */
        ...
        /* Botones - colores modernizados y suaves */
        .btn-light {
        ...
        /* btn-urgencia, color rojo vivo con transición suave */
        .btn-urgencia {
        ...
        /* btn-success con degradado sutil */
        .btn-success {
        ...
        .btn-success:focus {
            ...
            box-shadow: 0 8px 25px rgba(33, 136, 52, 0.8);
            transform: scale(1.05);
            outline: none;
        }
        ...
        .btn-success:active {
            ...
            box-shadow: 0 4px 12px rgba(33, 117, 31, 0.6);
        }
...
<body style="background-color: aliceblue;">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="menuPrincipal">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a class="btn btn-outline-light" href="../usuario/paciente_user.php">Vista de usuario</a>
    ...
    <div class="content">
        <div class="container my-4">
            <div class="section-header">
                <h1 class="h2 mb-0">Días Paciente</h1>
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center my-3 gap-2">
                <div class="d-flex flex-wrap align-items-center gap-2">
                    <a href="./ingresar-paciente.php" class="btn btn-urgencia">➕ Agregar manual</a>
                    <a href="./agregar-paciente.php" class="btn btn-urgencia">📥 Cargar archivo</a>
                    <a href="./actualizar-paciente.php" class="btn btn-urgencia"
                ...
                <div class="d-flex justify-content-center align-items-center gap-2">
                    <form id="formDescargarExcel" action="./descargar-excel_paciente.php" method="post" class="m-0">
            ...
            <!-- Tabla -->
            <?php
            $urgencias = Paciente::listar();
            if (count($urgencias) > 0) { ?>
                <div class="card shadow-sm mt-5">
                    <div class="card-header">
                        <h5 class="mb-0">Tabla de Días Paciente</h5>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    foreach ($urgencias as $u) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-light btn-sm" href="./editar-paciente.php?id=<?= base64_encode($u['id']) ?>">Editar</a>
                                            </td>
                                            <td>
                                                <a class="btn btn-light btn-sm" href="../../controladores/dias_pacientes.php?a=Eliminar&id=<?= base64_encode($u['id']) ?>" onclick="return confirm('¿Desea eliminar este registro?')">Eliminar</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
    ...
    <script>
        document.getElementById('btnDescargarGraficoPDF').addEventListener('click', async () => {
            ...
            pdf.save("grafico-tablas-dias-paciente.pdf");
