...
$consulta = $conexion->consultar('SELECT DISTINCT clave, anio, especialidad, division FROM paciente');
$conexion->cerrar();
...
<head>
    ...
    <title>Reemplazar Registros - Días paciente</title>
        ...
        <div class="container mt-5">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form id="csvForm" action="../../controladores/dias_pacientes.php" method="post" enctype="multipart/form-data">
                ...
                <div class="card-footer text-end">
                    <a href="./pacientes_inicio.php" class="btn btn-outline-secondary"><i class="bi bi-arrow-left"></i>
                        Volver</a>
                </div>
            </div>
        </div>
