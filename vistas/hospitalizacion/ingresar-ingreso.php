...
<head>
    ...
    <title>Ingresar datos | Ingresos</title>
...
<body style="background-color: aliceblue;">
    ...
    <div class="content">
        ...
        <div class="container mt-4">
            <div class="card p-4">
                <h4 class="text-center">Ingresar datos - Ingreso</h4>
                ...
                <?php endif; ?>
                <br>
                <form id="formIngreso" action="../../controladores/ingresos.php" method="post">
    ...
    <script>
        ...
        $('#buscarClave').on('click', function() {
            ...
            $.ajax({
                type: 'GET',
                url: '../../controladores/buscarIngresoPorClave.php',
                data: {
                    clave: clave,
                    anio: anio
                },
