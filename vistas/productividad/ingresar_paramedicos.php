...
<head>
    ...
    <title>Ingresar datos | Paramédicos | Administrador</title>
...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #7a123a;">
    ...
    <div class="content">
        ...
        <div class="container mt-4">
            <div class="card p-4">
                <h4 class="text-center">Ingresar datos - Paramédicos</h4>
                ...
                <?php endif; ?>
                <br>
                <form id="formParamedico" action="../../controladores/paramedicos.php" method="post">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="input-group">
                                ...
                                <button type="button" class="btn btn-success" id="limpiarFormulario">Limpiar</button>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        document.getElementById('formParamedico').addEventListener('submit', function(e) {
...
<script>
    ...
    $('#buscarClave').on('click', function () {
        ...
        $.ajax({
            type: 'GET',
            url: '../../controladores/buscarParamedicoPorClave.php',
            data: { clave: clave, anio: anio },
            dataType: 'json',
