...
$consulta = $conexion->consultar('SELECT DISTINCT clave, anio, especialidad, division FROM urgencias');
$conexion->cerrar();
...
<head>
    ...
    <title>Actualizar datos | Urgencias | Administrador</title>
        ...
        <div class="container mt-5">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form id="csvForm" action="../../controladores/urgencias.php" method="post" enctype="multipart/form-data">
                ...
                <div class="card-footer text-end">
                    <a href="./urgencias_inicio.php" class="btn btn-outline-secondary"><i class="bi bi-arrow-left"></i>
                        Volver</a>
                </div>
            </div>
        </div>
    ...
    <script>
        document.getElementById('csvForm').addEventListener('submit', function(e) {
            ...
            reader.onload = function(event) {
                ...
                fetch('../../controladores/urgencias.php', {
                        method: 'POST',
                        body: formData
                    })
                    ...
                    .then(data => {
                        if (data.status === 'success') {
                            ...
                            setTimeout(() => {
                                window.location.href = './urgencias_inicio.php';
                            }, 3000);
