...
<head>
    ...
    <title>Ingresar datos | Urgencias | Administrador</title>
...
<body style="background-color: aliceblue;">
    ...
    <div class="content">
        ...
        <div class="container mt-4">
            <div class="card p-4">
                <h4 class="text-center">Ingresar datos - Urgencias</h4>
                ...
                <?php endif; ?>
                <br>
                <form id="formUrgencia" action="../../controladores/urgencias.php" method="post">
