...
----------------------------------- */
        ...
        .section-header {
            ...
            /* Fondo gris claro */
            border-left: 5px solid rgb(34, 117, 112);
            padding: 15px 20px;
            border-radius: 8px;
            ...
            <div class="collapse navbar-collapse" id="menuPrincipal">
                ...
                <div class="d-flex align-items-center gap-2">
                    <a class="btn btn-outline-light" onclick="anterior()" href="#" title="Atrás"><i class="bi bi-arrow-left"
                            ></i></a>
                    <a class="btn btn-outline-light" href="../usuario/especialidades_user.php">Vista de usuario</a>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="../usuario/especialidades_user.php"><i class="fas fa-eye me-2"></i>Ver
                                    como Usuario</a></li>
    ...
    <div class="content">
        <div class="container my-4">
            <div class="section-header">
                <h1 class="h2 mb-0">Especialidades Total</h1>
            ...
            <div class="d-flex gap-2 align-items-center justify-content-center mb-3">
                <a class="btn btn-success"  href="./Especialidad_Ocasion.php">📝 Editar Tabla</a>
                <form id="formDescargarExcel" action="./Excel_especialidad-total.php" method="post" class="m-0">
...
<p id="mensajeSinDatosMensualDivision2" style="display:none; color:red;"><strong>No hay datos disponibles.</strong></p>
              ...
              <br>
                ...
                <p id="mensajeSinDatos2" style="display: none; color: red;"><strong>No hay datos ingresados.</strong>
                </p>
...
<tfoot>
  <tr style="background-color: #d1e7dd; font-weight: bold; border-top: 2px solid #0f5132; color: #0f5132;">
    <td colspan="3" class="text-center align-middle" style="background-color: #f2fefbff;" >Total General</td>
    <?php foreach ($meses as $mes): ?>
        <td style="background-color: #f2fefbff;" id="total_<?= $mes ?>">0</td>
    <?php endforeach; ?>
    <td id="total_general" style="background-color: #cfffecff; font-size: medium; font-weight: 800; color: #076b7dff;">0</td>
    <td></td>
  </tr>
</tfoot>
...
const nombresMeses2 = ['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre'];
...
function actualizarTodosFiltros2() {
  ...
  const selects = [
    { selector: '#filtroAnio2', valores: aniosDisponibles, seleccionados: aniosSel },
    { selector: '#filtroEspecialidad2', valores: especialidadesDisponibles, seleccionados: espSel },
    { selector: '#filtroDescripcion2', valores: descripcionesDisponibles, seleccionados: descSel }
  ];
  ...
  selects.forEach(({ selector, valores }) => {
  ...
  selects.forEach(({ selector, seleccionados, valores }) => {
...
const datasetsMensuales = datosFiltrados.map(e => ({
  ...
  chartMeses2 = new Chart(document.getElementById('graficoMeses2').getContext('2d'), {
    type: 'line',
    data: { labels: nombresMeses2, datasets: datasetsMensuales },
    options: {
      responsive: true,
  ...
  chartTotalGeneral2 = new Chart(document.getElementById('graficoTotalGeneral2').getContext('2d'), {
    ...
    data: {
      ...
      datasets: [{
        ...
        backgroundColor: labels.map((_, i) =>
          incluirTotalGeneral && i === labels.length - 1 ? 'black' : coloresFijos[i % coloresFijos.length]),
    ...
    options: {
      ...
      plugins: {
        legend: { display: true },
        datalabels: {
          anchor: 'end', align: 'start', offset: 4, color: '#555',
...
function actualizarGraficoMensualDivision2() {
  ...
  chartMensualDivision2 = new Chart(canvas.getContext('2d'), {
    type: 'line',
    data: { labels: nombresMeses2, datasets },
    options: {
      responsive: true,
      scales: { y: { beginAtZero: true } }
    }
...
actualizarTotalesEspecialidades();
  ...
  $('#filtroAnio2, #filtroEspecialidad2, #filtroDescripcion2, #filtroAnioTabla2').val(null).trigger('change');
...
function actualizarTotalesEspecialidades() {
  ...
  columnasMeses.forEach((mes, index) => {
    let suma = 0;
    tabla2.column(index + 3, { search: 'applied' }).nodes().each(function (cell) {
...
<script>
    document.getElementById('formDescargarExcel').addEventListener('submit', function(e) {
        ...
        document.getElementById('inputEspecialidad').value = getMultipleValues(document.getElementById('filtroEspecialidad2'));
        document.getElementById('inputDescripcion').value = getMultipleValues(document.getElementById('filtroDescripcion2'));
    });
</script>
...
document.getElementById('btnDescargarGraficoPDF2').addEventListener('click', async () => {
    ...
    pdf.text("UNIDAD MÉDICA DE ALTA ESPECIALIDAD", 105, 12, { align: "center" });
    pdf.setFont(undefined, "normal");
    pdf.text("HOSPITAL DE GINECO - PEDIATRÍA No. 48", 105, 18, { align: "center" });
    pdf.text("ESPECIALIDADES TOTAL", 105, 24, { align: "center" });
    ...
    pdf.text(`Fecha: ${fecha}`, 105, pageHeight - 16, { align: "center" });
    pdf.text("Instituto Mexicano del Seguro Social", 105, pageHeight - 11, { align: "center" });
