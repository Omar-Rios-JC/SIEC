...
<head>
    ...
    <title>Agregar datos | Especialidad de Ocasión | Administrador</title>
    ...
    <div class="container mt-5">
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-dark text-white">
                <h5 class="mb-0"><i class="bi bi-upload me-2"></i>Cargar excel.csv para agregar registros - Especialidad de ocasión</h5>
            </div>
            <div class="card-body">
                <form id="formCSV" action="../../controladores/Especialidad_Ocasion.php" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive" style="max-height: 150px; overflow-y: auto;">
                    <table class="table table-bordered table-sm">
                        <tbody>
                            <?php
                            $ruta_csv = '../../especialidades_ejemplo.csv';
                ...
                <a href="../../especialidades_ejemplo.csv" class="btn btn-success mt-3" download>
        ...
        document.getElementById('formCSV').addEventListener('submit', function(e) {
            ...
            fetch('../../controladores/Especialidad_Ocasion.php', {
                ...
                .then(data => {
                    ...
                    alerta.className = `alert alert-${alertTypes[data.status] || 'danger'} alert-dismissible fade show mb-2`;
