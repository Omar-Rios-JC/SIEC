...
$consulta = $conexion->consultar('SELECT DISTINCT clave, anio, especialidad, division FROM paramedicos');
$conexion->cerrar();
...
<head>
    ...
    <title>Actualizar datos | Paramédicos | Administrador</title>
    <style>
        ...
        <div class="container mt-5">
            <div class="card shadow-sm">
                <div class="card-header bg-success text-white">
                    <h5 class="mb-0"><i class="bi bi-exclamation-triangle-fill me-2"></i> Reemplazar registros
                    </h5>
                </div>
                <div class="card-body">
                    <div class="alert alert-warning d-flex align-items-center" role="alert">
                        <i class="bi bi-exclamation-circle-fill me-2"></i>
                        <div><strong>Atención:</strong> Esto eliminará los registros actuales y los reemplazará con
                            los del nuevo archivo cargado según los filtros seleccionados.</div>
                    </div>

                    <!-- Contenedor para alertas -->
                    <div id="alert-container" style="position: fixed; top: 20px; right: 20px; z-index: 1050;"></div>

                    <form id="csvForm" action="../../controladores/paramedicos.php" method="post" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="btn btn-warning">Actualizar solo Coincidencias</button>
                    </form>

                </div>
                <div class="card-footer text-end">
                    <a href="./paramedicos.php" class="btn btn-outline-secondary"><i class="bi bi-arrow-left"></i>
                        Volver</a>
                </div>
            </div>
        </div>
