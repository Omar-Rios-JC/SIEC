...
<head>
    ...
    <title>Urgencias | Administrador</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="menuPrincipal">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a class="btn btn-outline-light" href="../usuario/urgencias_user.php">Vista de usuario</a>
        ...
        <div class="container my-4">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center my-3 gap-2">
                <div class="d-flex flex-wrap align-items-center gap-2">
                    <a href="./ingresar-urgencias.php" class="btn btn-urgencia">➕ Agregar manual</a>
                    <a href="./agregar-urgencias.php" class="btn btn-urgencia">📥 Cargar archivo</a>
                    <a href="./actualizar-urgencias.php" class="btn btn-urgencia"
                ...
                <div class="d-flex justify-content-center align-items-center gap-2">
                    <form id="formDescargarExcel" action="./excel_urgencias.php" method="post" class="m-0">
            ...
            <div id="graficosContainer" style="display: none;">
                ...
                <div class="info-card mb-4">
                    ...
                    <p id="mensajeSinDatosMensualDivision" style="display: none; color: red;"><strong>No hay datos ingresados.</strong></p>
                </div>
                            ...
                            <table class="table table-bordered align-middle text-center" id="tabla-urgencias">
                                ...
                                <tbody>
                                    ...
                                    foreach ($urgencias as $u) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-light btn-sm" href="./editar-urgencias.php?id=<?= base64_encode($u['id']) ?>">Editar</a>
                                            </td>
                                            <td>
                                                <a class="btn btn-light btn-sm" href="../../controladores/urgencias.php?a=Eliminar&id=<?= base64_encode($u['id']) ?>" onclick="return confirm('¿Desea eliminar este registro?')">Eliminar</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                                ...
                                <tfoot id="tfootTotales" class="table-light">
                                    <tr style="background-color: #f4f9f4; font-weight: bold;">
                                        <td colspan="3" class="text-center align-middle" style="background-color: #ffefefff;">Total General</td>
                                        <?php foreach ($meses as $mes): ?>
                                            <td id="total-<?= $mes ?>" class="text-center align-middle" style="background-color: #ffefefff;">0</td>
                                        <?php endforeach; ?>
                                        <td style="background-color: #ed8585ff; color: #7d0000ff; font-weight: 1000; font-size:medium" id="total-general" class="text-center align-middle">0</td>
                                        <td colspan="3"></td>
                                    </tr>
                                </tfoot>
