...
<head>
    ...
    <title>Paramédicos | Administrador</title>
...
----------------------------------- */
    ...
    .section-header {
        ...
        /* Fondo gris claro */
        border-left: 5px solid rgb(9, 104, 14);
...
<body style="background-color: aliceblue;">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="menuPrincipal">
                        ...
                        <ul class="dropdown-menu" data-bs-auto-close="outside">
                            ...
                            <li>
                                ...
                                <ul class="dropdown-submenu">
                                    <li><a class="dropdown-item" href="./unidades_que_reportan.php">Productividad
                                            total</a></li>
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a class="btn btn-outline-light" href="../usuario/paramedicos_user.php">Vista de usuario</a>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="../usuario/paramedicos_user.php"><i
    ...
    <div class="content">
        ...
        <div class="container my-4">
            <div class="section-header">
                <h1 class="h2 mb-0">Paramédicos</h1>
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center my-3 gap-2">
                <div class="d-flex flex-wrap align-items-center gap-2 ">
                    <a href="ingresar_paramedicos.php" class="btn btn-urgencia">➕ Agregar nuevo registro</a>
                    <a href="agregar_paramedicos.php" class="btn btn-urgencia">📥 Cargar archivo</a>
                    <a href="actualizarParamedicos.php" class="btn btn-urgencia"
                        onclick="return confirm('¿Seguro que desea hacer reemplazo de datos en los registros?')">
                        🔁 Actualizar datos
                    </a>
                </div>
                <div class="d-flex justify-content-center align-items-center gap-2">
                    <form id="formDescargarExcel" action="descargar_excel_paramedicos.php" method="post" class="m-0">
            ...
            <div id="filtrosContainer" class="filter-container-inline" style="display: none;">
                <div id="selectorAnioContainer" style="display:none;">
                    ...
                    <select id="selectAnio" class="form-select select-personalizado" onchange="actualizarGrafico()"
                        multiple></select>
                </div>

                <div id="selectorDescripcionContainer" style="display:none;">
                    <label for="selectDivision" class="form-label">División:</label>
                    <select id="selectDivision" class="form-select select-personalizado" onchange="actualizarGrafico()"
                        multiple>
                    </select>
                </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="row mb-3 justify-content-end">
                                <div class="col-md-3 col-sm-6 d-flex align-items-center gap-2">
                                    <label for="filtroAnioTablaParamedicos"
                                        class="form-label mb-0 fw-semibold text-dark">Año:</label>
                                    <select id="filtroAnioTablaParamedicos"
                            ...
                            <table class="table table-bordered align-middle text-center" id="tabla-paramedicos">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                                ...
                                                $granTotal += $total;
                                                ?>
                                        <td style="background-color: #f9fff8ff;#f8e6ed;"><strong><?= $total ?></strong>
                                        </td>
                                        <td><?= htmlspecialchars($u['anio']) ?></td>
                                        <td>
                                            <a class="btn btn-light btn-sm"
                                                href="./editarParamedico.php?id=<?= base64_encode($u['id']) ?>">Editar</a>
                                        </td>
                                        <td>
                                            <a class="btn btn-light btn-sm"
                                                href="../../controladores/paramedicos.php?a=Eliminar&id=<?= base64_encode($u['id']) ?>"
                                ...
                                <tfoot id="tfootTotales" class="table-light">
                                    <tr id="filaTotales"
                                        ...
                                        <td colspan="3" style="background-color: #f9fff8ff;"
                                            class="text-center align-middle">Total General</td>

                                        <?php foreach ($meses as $mes): ?>
                                        <td class="total-col text-center align-middle"
                                            style="background-color: #f9fff8ff;" data-mes="<?= $mes ?>">0</td>
                                        <?php endforeach; ?>

                                        <td class="total-general text-center align-middle"
                                            style="background-color: #cfffd5ff; font-size: 1.1rem; font-weight: 800; color: #056505ff;">
                                            0</td>
    ...
    function actualizarFiltrosYGraficos() {
        ...
        const nuevosAnios = [...new Set(
            paramedicosData
            .filter(p =>
                (seleccionadosEspecialidad.length === 0 || seleccionadosEspecialidad.includes(p
                .especialidad)) &&
                (seleccionadosDivision.length === 0 || seleccionadosDivision.includes(p.division))
            )
            .map(p => p.anio)
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: etiquetas.map((etiqueta, i) =>
                        etiqueta === "Total General Anual" ? '#000' : coloresFijos[i % coloresFijos
                            .length]
                    ),
                    borderColor: etiquetas.map((etiqueta, i) =>
                        etiqueta === "Total General Anual" ? '#111' : coloresFijos[i % coloresFijos
                            .length]
                    ),
                    borderWidth: 2
                }]
    ...
    $(document).ready(function() {
        ...
        $('#filtroAnioTablaParamedicos').on('change', function() {
            ...
            if (JSON.stringify(aniosSeleccionados.sort()) !== JSON.stringify(aniosActualesGrafico
                .sort())) {
    ...
    $('#filtroAnioTablaParamedicos').on('change', function() {
        ...
        const aniosActualesGrafico = $('#selectAnio').val() || [];
        const sonIguales = JSON.stringify(aniosSeleccionados.sort()) === JSON.stringify(aniosActualesGrafico
            .sort());
