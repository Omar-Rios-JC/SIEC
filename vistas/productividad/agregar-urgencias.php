...
<head>
    ...
    <title>Agregar datos | Urgencias | Administrador</title>
    ...
    <div class="container mt-5">
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-danger text-white">
                <h5 class="mb-0"><i class="bi bi-upload me-2"></i>Cargar excel.csv para agregar registros - Urgencias</h5>
            </div>
            <div class="card-body">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive" style="max-height: 150px; overflow-y: auto;">
                    <table class="table table-bordered table-sm">
                        <tbody>
                            <?php
                            $ruta_csv = '../../Urgencias_ejemplo.csv';
                ...
                <a href="../../Urgencias_ejemplo.csv" class="btn btn-warning mt-3" download>
