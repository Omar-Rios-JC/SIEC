...
----------------------------------- */
        ...
        /* Fila alterna para mejor lectura */
...
----------------------------------- */
   ...
   ----------------------------------- */
        ...
        /* Botones - colores modernizados y suaves acorde a la tabla */
        .btn-light {
        ...
        .btn-light:hover {
            ...
            /* fondo más intenso al pasar el mouse */
            color: #311b92;
            /* texto más intenso */
        }

        /* Botón del gráfico (btnGrafico) */
        #btnGrafico {
        ...
        /* Estilo general para los botones de acciones */
        .btn-urgencia {
            background-color: #7e57c2;
            /* morado medio */
            color: #fff;
        ...
        /* Botones de exportación en verde actual (puedes mantenerlos o personalizarlos también) */
        .btn-success {
            background-color: #ab47bc;
            /* tono rosado-morado más claro */
            border: none;
            color: #fff;
            font-weight: 500;
            transition: background-color 0.3s ease, transform 0.2s;
...
<body style="background-color: aliceblue;">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="menuPrincipal">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a class="btn btn-outline-light" href="../usuario/cirugia_user.php">Vista de usuario</a>
        ...
        <div class="container my-4">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center my-3 gap-2">
                <div class="d-flex flex-wrap align-items-center gap-2">
                    <a href="./ingresar-cirugia.php" class="btn btn-urgencia">➕ Agregar manual</a>
                    <a href="./agregar-cirugia.php" class="btn btn-urgencia">📥 Cargar archivo</a>
                    <a href="./actualizar-cirugia.php" class="btn btn-urgencia"
                ...
                <div class="d-flex justify-content-center align-items-center gap-2">
                    <form id="formDescargarExcel" action="./descargar-excel_cirugia.php" method="post" class="m-0">
                    ...
                    <a id="btnDescargarGraficoPDF" class="btn btn-success">📈 Descargar Gráfico PDF</a>
            ...
            <div id="graficoCard" class="info-card" style="display: none;">
                <h4>Gráfico Cirugías</h4>
                <canvas id="graficoUrgencias" width="400" height="200"></canvas>
                <p id="mensajeSinDatos" style="display: none; color: red;"><strong>No hay datos ingresados.</strong></p><br>

                <h4>Gráfico Mensual por División</h4>
                <canvas id="graficoMensualDivision" width="400" height="180"></canvas>
                <p id="mensajeSinDatosMensualDivision" style="display: none; color: red;"><strong>No hay datos ingresados.</strong></p><br>
            ...
            <!-- Tabla -->
            <?php
            $urgencias = Cirugia::listar();
            if (count($urgencias) > 0) { ?>
                <div class="card shadow-sm mt-5">
                    <div class="card-header">
                        <h5 class="mb-0">Tabla de Cirugías</h5>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    foreach ($urgencias as $u) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-light btn-sm" href="./editar-cirugia.php?id=<?= base64_encode($u['id']) ?>">Editar</a>
                                            </td>
                                            <td>
                                                <a class="btn btn-light btn-sm" href="../../controladores/cirugias.php?a=Eliminar&id=<?= base64_encode($u['id']) ?>" onclick="return confirm('¿Desea eliminar este registro?')">Eliminar</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
    ...
    <script>
        document.getElementById('btnDescargarGraficoPDF').addEventListener('click', async () => {
            ...
            pdf.save("grafico-tablas-cirugias.pdf");
    ...
    <script>
        document.getElementById('btnDescargarImagenesCanvasUrgencias').addEventListener('click', function() {
            exportarCanvasConFondo('graficoUrgencias', 'grafico_mensual_cirugia.png');
            exportarCanvasConFondo('graficoMensualDivision', 'grafico_mensual_cirugia.png');
            exportarCanvasConFondo('graficoTotales', 'grafico_anual_division_cirugia.png');
        });
