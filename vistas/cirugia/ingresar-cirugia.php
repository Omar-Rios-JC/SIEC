...
<head>
    ...
    <title>Ingresar datos | Cirugía</title>
...
<body style="background-color: aliceblue;">
    ...
    <div class="content">
        ...
        <div class="container mt-4">
            <div class="card p-4">
                <h4 class="text-center">Ingresar datos - Cirugía</h4>
                ...
                <?php endif; ?>
                <br>
                <form id="formCirugia" action="../../controladores/cirugias.php" method="post">
    ...
    <script>
        ...
        $('#buscarClave').on('click', function() {
            ...
            $.ajax({
                type: 'GET',
                url: '../../controladores/buscarCirugiasporClave.php',
                data: {
                    clave: clave,
                    anio: anio
                },
