...
if (!$id) {
    header('Location: cirugia_inicio.php?error=ID no válido');
    exit;
}

$esp = Cirugia::obtenerPorId($id);
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="menuPrincipal">
            ...
            <div class="d-flex align-items-center gap-2">
                <a href="./urgencias_inicio.php" class="btn btn btn-outline-light"><i class="bi bi-arrow-left"
                                                                                      title="Atrás"></i></a>
                <div class="dropdown">
...
<div class="content">
    ...
    <div class="container mt-4">
        <div class="card p-4">
            <h4 class="text-center">Editar Datos de días paciente</h4>
            <form method="POST" action="../../controladores/cirugias.php">
                ...
                <div class="d-flex justify-content-center gap-2 mt-4">
                    <a href="./cirugia_inicio.php" class="btn btn-outline-secondary">
