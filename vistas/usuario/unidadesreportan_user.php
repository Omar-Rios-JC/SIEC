...
<head>
    ...
    <title>UMAE-48 | Productividad Total</title>
...
<body style="background-color: aliceblue;">
    ...
    <div class="content">
        <div class="container my-4">
            <h1 style="text-align: center; color: #495057; font-weight:bold">Productividad Total</h1><br>


            <div>
                <div class="d-flex gap-2 align-items-center justify-content-center mb-3">
                    <form id="formDescargarExcel" action="../productividad/descargar_excel_unidades_que_reportan.php" method="post" class="m-0">
