...
<body style="background-color: aliceblue;">
    ...
    <div class="content">
        <div class="container my-4">
            <h1 style="text-align: center; color: #495057; font-weight:bold">Egresos</h1><br>
            <hr>
            ...
            <div class="d-flex flex-wrap justify-content-center align-items-center my-3 gap-2">
                ...
                <div class="d-flex justify-content-center align-items-center gap-2">
                    <form id="formDescargarExcel" action="../hospitalizacion/descargar-excel_egreso.php" method="post" class="m-0">
