...
<head>
    ...
    <title>UMAE-48 | Especialidad de ocasión</title>
...
<body style="background-color: aliceblue;">
    ...
    <div class="content">
        ...
        <div class="container my-4">
            <h1 style="text-align: center; color: #495057; font-weight:bold">Especialidades de Ocasión</h1><br>

            <div class="d-flex flex-wrap justify-content-between align-items-center my-3 gap-2">
                <div class="d-flex justify-content-center align-items-center gap-2">
                    <a class="btn btn-success" href="./Especialidades_user.php">📈 Ir a Especialidades</a>
                    <form id="formDescargarExcel" action="../productividad/descargar_excel.php" method="post" class="m-0">
                                ...
                                <table class="table table-bordered align-middle text-center" id="tabla">
                                    <thead>
                                        <tr>
                                            ...
                                            ?>
                                            <th rowspan="2">Año</th>
                                            <th colspan="2" style="display:none">Opciones </th>
                                        </tr>
                                        <tr>
    ...
    <script>
        document.getElementById('btnDescargarGraficoPDF2').addEventListener('click', async () => {
            ...
            pdf.setFont(undefined, "bold");
            pdf.text("ESPECIALIDADES DE OCASIÓN", 105, 28, {
                align: "center"
            });
            ...
            pdf.text(`Fecha: ${fecha}`, 105, pageHeight - 18, {
                align: "center"
            });

            // Pie institucional
            pdf.setFontSize(10);
            pdf.text("Instituto Mexicano del Seguro Social", 105, pageHeight - 12, {
                align: "center"
            });
