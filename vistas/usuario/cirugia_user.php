...
<body style="background-color: aliceblue;">
    ...
    <div class="content">
        <div class="container my-4">
            <h1 style="text-align: center; color: #495057; font-weight:bold">Cirugía</h1><br>
            <hr>
            ...
            <div class="d-flex flex-wrap justify-content-center align-items-center my-3 gap-2">
                ...
                <div class="d-flex justify-content-center align-items-center gap-2">
                    <form id="formDescargarExcel" action="../cirugia/descargar-excel_cirugia.php" method="post"
                        class="m-0">
                            ...
                            <table class="table table-bordered align-middle text-center" id="tabla-urgencias">
                                ...
                                <tfoot id="tfootTotales" class="table-light">
                                    <tr style="background-color: #f4f9f4; font-weight: bold;">
                                        ...
                                        <?php endforeach; ?>
                                        <td style="background-color: #e2c8dd;" id="total-general"
                                            class="text-center align-middle">0</td>
                                        <td colspan="1"></td>
                                    </tr>
                                </tfoot>
