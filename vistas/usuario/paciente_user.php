...
<head>
    ...
    <title>UMAE-48 | Días Paciente</title>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #00664d;">
    ...
    <div class="content">
        <div class="container my-4">
            <h1 style="text-align: center; color: #495057; font-weight:bold">Días Paciente</h1><br>
            <hr>

            <!-- Botones -->
            <div class="d-flex flex-wrap justify-content-center align-items-center my-3 gap-2 text-center">

                <form id="formDescargarExcel" action="../hospitalizacion/descargar-excel_paciente.php" method="post" class="m-0">
