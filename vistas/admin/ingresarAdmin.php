...
<head>
    ...
    <title>Ingresar nuevo administrador | Administrador</title>
...
<body style="background-color: aliceblue;">
    ...
    <div class="container mt-5">
        <div class="form-container">
            <div class="card-custom">
                <h4 class="text-center mb-4">Ingresar nuevo administrador</h4>
                <form action="registerauthAdmin.php" method="post">
                    <div class="mb-3">
                        <input type="text" name="names" class="form-control" placeholder="Nombre completo" required>
                    </div>
                    <div class="mb-3">
                        <input type="email" name="email" class="form-control" placeholder="Correo electrónico" required>
                    </div>
                    <div class="mb-3 position-relative">
                        <input type="password" name="password" id="panelPassword" class="form-control" placeholder="Contraseña" required>
                        <i class="bi bi-eye-slash" id="togglePanelPassword" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); cursor: pointer;"></i>
                    </div>

                    <div class="d-grid">
                        <input type="submit" name="btnRegister" value="Ingresar" class="btn btn-dark-custom">
                    </div>
                </form>
            </div>
        </div>
    ...
    <!-- JS -->
    <script>
        const togglePanelPassword = document.getElementById('togglePanelPassword');
        const panelPasswordInput = document.getElementById('panelPassword');

        togglePanelPassword.addEventListener('click', function() {
            const isPassword = panelPasswordInput.type === 'password';
            panelPasswordInput.type = isPassword ? 'text' : 'password';
