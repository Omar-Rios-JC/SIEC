...
$manual = Manual::obtenerPorId(base64_decode($_GET['id']));
...
<body style="background-color: aliceblue;">
    ...
    <div class="container mt-5">
        <div class="section-header mb-4">
            <h2 class="h4 mb-0">Editar</h2>
            <small class="text-muted">Edita los manuales existentes</small>
        </div>
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form action="../../controladores/Normatividades.php" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="archivo_actual" value="<?= htmlspecialchars($manual[7]) ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="normatividad" name="normatividad" required>
                            ...
                            <option value="Externa" <?= $manual[1] === 'Externa' ? 'selected' : '' ?>>Externa</option>
                            <option value="Interna" <?= $manual[1] === 'Interna' ? 'selected' : '' ?>>Interna</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nombre" name="nombre" value="<?= htmlspecialchars($manual[2]) ?>" required>
                    </div>

                    <div class="mb-3">
                        <label for="anio" class="form-label">Año</label>
                        <input type="date" class="form-control" id="anio" name="anio" value="<?= htmlspecialchars($manual[3]) ?>" required>
                    </div>

                    <div class="mb-3">
                        <label for="entidad" class="form-label">Entidad</label>
                        <input type="text" class="form-control" id="entidad" name="entidad" value="<?= htmlspecialchars($manual[4]) ?>" required>
                    </div>

                    <div class="mb-3">
                        <label for="servicio" class="form-label">Servicio</label>
                        <input type="text" class="form-control" id="servicio" name="servicio" value="<?= htmlspecialchars($manual[5]) ?>" required>
                    </div>

                    <div class="mb-3">
                        <label for="fecha" class="form-label">Clave</label>
                        <input type="text" class="form-control" id="fecha" name="fecha"
                            value="<?= htmlspecialchars($manual[6]) ?>"
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="direccion" name="direccion" required>
                            ...
                            <option value="Dirección Médica" <?= $manual[8] === 'Dirección Médica' ? 'selected' : '' ?>>Dirección Médica</option>
                            <option value="Dirección General" <?= $manual[8] === 'Dirección General' ? 'selected' : '' ?>>Dirección General</option>
                            <option value="Dirección Educación e Investigación en Salud" <?= $manual[8] === 'Dirección Educación e Investigación en Salud' ? 'selected' : '' ?>>Dirección Educación e Investigación en Salud</option>
                            <option value="Dirección Enfermería" <?= $manual[8] === 'Dirección Enfermería' ? 'selected' : '' ?>>Dirección Enfermería</option>
                            <option value="Dirección Administrativa" <?= $manual[8] === 'Dirección Administrativa' ? 'selected' : '' ?>>Dirección Administrativa</option>
                        </select>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Archivo actual:</label>
                        <p><a href="../../archivos/manuales/<?= htmlspecialchars($manual[7]) ?>" target="_blank">Ver PDF</a></p>
                    </div>
                    ...
                    <button type="submit" name="a" value="Editar" class="btn btn-primary">Guardar Cambios</button>
                </form>
            </div>
        </div>
    </div>
