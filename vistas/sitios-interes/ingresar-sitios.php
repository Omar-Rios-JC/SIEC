...
<head>
    <meta charset="UTF-8" />
    <title>Agregar Sitio de Interés | Administrador</title>
    <!-- Bootstrap y estilos -->
        ...
        <div class="container mt-4">
            <div class="card shadow-sm">
                <div class="card-header bg-secondary text-white">
                    <h4 class="mb-0">Agregar Nuevo Sitio de Interés</h4>
                </div>
                <div class="card-body">
                    <form action="../../controladores/SitiosInteres.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control" id="ruta" name="ruta" placeholder="https://ejemplo.com" required>
                        </div>

                        <div class="d-flex justify-content mt-3">
                            <a href="index.php" class="btn btn-outline-secondary mb-4">Regresar</a>
                            <button type="submit" name="a" value="Subir" class="btn btn-outline-warning2 mb-4 ms-2">Guardar Cambios</button>
                        </div>
                    </form>
                </div>
            </div>
