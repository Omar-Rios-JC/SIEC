...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['archivo_csv'])) {
        ...
        if (($handle = fopen($fileTmpPath, "r")) !== FALSE) {
            ...
            echo json_encode([
                'success' => true, 
                'message' => "¡Carga Exitosa! Formato encapsulado de la plataforma procesado correctamente. Egresos nuevos: $registrosInsertados, Duplicados saltados: $duplicadosSaltados."
            ]);
        }
    }
