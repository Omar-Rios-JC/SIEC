...
class Ingreso
{
    ...
    public static function listar()
    {
        ...
        $consulta = $conexion->consultar('SELECT * FROM ingresos');
        $conexion->cerrar();
    ...
    public function claveAnioExiste($clave, $anio)
    {
        ...
        $anio = intval($anio);
        $sql = "SELECT COUNT(*) as total FROM ingresos WHERE clave = $clave AND anio = $anio";
    ...
    public function insertarNuevo()
    {
        ...
        $sql = "INSERT INTO ingresos (" . implode(', ', $campos) . ")
    ...
    public function actualizarCamposVacios()
    {
        ...
        $sql = "UPDATE ingresos SET " . implode(", ", $camposUpdate) .
    ...
    {
        $sql = "DELETE FROM ingresos WHERE id = " . intval($this->id);
        return $this->conexion->actualizar($sql);
    }
    ...
    public static function obtenerPorId($id)
    {
        ...
        $listado = $conexion->consultar("SELECT * FROM ingresos WHERE id = $idEscapado");
        $conexion->cerrar();
    ...
    public static function obtenerPorClaveYAnio($clave, $anio)
    {
        ...
        $resultado = $conexion->consultar("SELECT * FROM ingresos WHERE clave = '$claveEsc' AND anio = $anioInt");
        $conexion->cerrar();
    ...
    {
        return $this->conexion->actualizar("TRUNCATE TABLE ingresos");
    }

    public static function contar()
    {
        $conexion = new Conexion();
        $consulta = $conexion->consultarUnaFila('SELECT COUNT(*) AS total FROM ingresos');
