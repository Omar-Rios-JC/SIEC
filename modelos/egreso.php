...
class Egreso
{
    ...
    public static function listar()
    {
        ...
        $consulta = $conexion->consultar('SELECT * FROM egresos');
        $conexion->cerrar();
    ...
    public function claveAnioExiste($clave, $anio)
    {
        ...
        $anio = intval($anio);
        $sql = "SELECT COUNT(*) as total FROM egresos WHERE clave = $clave AND anio = $anio";
    ...
    public function insertarNuevo()
    {
        ...
        $sql = "INSERT INTO egresos (" . implode(', ', $campos) . ")
    ...
    public function actualizarCamposVacios()
    {
        ...
        $sql = "UPDATE egresos SET " . implode(", ", $camposUpdate) .
    ...
    {
        $sql = "DELETE FROM egresos WHERE id = " . intval($this->id);
        return $this->conexion->actualizar($sql);
    }
    ...
    public static function obtenerPorId($id)
    {
        ...
        $listado = $conexion->consultar("SELECT * FROM egresos WHERE id = $idEscapado");
        $conexion->cerrar();
    ...
    public static function obtenerPorClaveYAnio($clave, $anio)
    {
        ...
        $resultado = $conexion->consultar("SELECT * FROM egresos WHERE clave = '$claveEsc' AND anio = $anioInt");
        $conexion->cerrar();
    ...
    {
        return $this->conexion->actualizar("TRUNCATE TABLE egresos");
    }

    public static function contar()
    {
        $conexion = new Conexion();
        $consulta = $conexion->consultarUnaFila('SELECT COUNT(*) AS total FROM egresos');
