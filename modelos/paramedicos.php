...
class Paramedicos
{
    ...
    public static function listar()
    {
        ...
        $consulta = $conexion->consultar('SELECT * FROM paramedicos');
        $conexion->cerrar();
    ...
    public function claveAnioExiste($clave, $anio)
    {
        ...
        $anio = intval($anio);
        $sql = "SELECT COUNT(*) as total FROM paramedicos WHERE clave = $clave AND anio = $anio";
    ...
    public function insertarNuevo()
    {
        ...
        $sql = "INSERT INTO paramedicos (" . implode(', ', $campos) . ")
    ...
    public function actualizarCamposVacios()
    {
        ...
        $sql = "UPDATE paramedicos SET " . implode(", ", $camposUpdate) .
    ...
    {
        $sql = "DELETE FROM paramedicos WHERE id = " . intval($this->id);
        return $this->conexion->actualizar($sql);
    }
    ...
    public static function obtenerPorId($id)
    {
        ...
        $listado = $conexion->consultar("SELECT * FROM paramedicos WHERE id = $idEscapado");
        $conexion->cerrar();
    ...
    public static function obtenerPorClaveYAnio($clave, $anio)
    {
        ...
        $resultado = $conexion->consultar("SELECT * FROM paramedicos WHERE clave = '$claveEsc' AND anio = $anioInt");
        $conexion->cerrar();
    ...
    {
        return $this->conexion->actualizar("TRUNCATE TABLE paramedicos");
    }

    public static function contar()
    {
        $conexion = new Conexion();
        $consulta = $conexion->consultarUnaFila('SELECT COUNT(*) AS total FROM paramedicos');
