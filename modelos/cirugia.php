...
class Cirugia
{
    ...
    public static function listar()
    {
        ...
        $consulta = $conexion->consultar('SELECT * FROM cirugia');
        $conexion->cerrar();
    ...
    public function claveAnioExiste($clave, $anio)
    {
        ...
        $anio = intval($anio);
        $sql = "SELECT COUNT(*) as total FROM cirugia WHERE clave = $clave AND anio = $anio";
    ...
    public function insertarNuevo()
    {
        ...
        $sql = "INSERT INTO cirugia (" . implode(', ', $campos) . ")
    ...
    public function actualizarCamposVacios()
    {
        ...
        $sql = "UPDATE cirugia SET " . implode(", ", $camposUpdate) .
    ...
    {
        $sql = "DELETE FROM cirugia WHERE id = " . intval($this->id);
        return $this->conexion->actualizar($sql);
    }
    ...
    public static function obtenerPorId($id)
    {
        ...
        $listado = $conexion->consultar("SELECT * FROM cirugia WHERE id = $idEscapado");
        $conexion->cerrar();
    ...
    public static function obtenerPorClaveYAnio($clave, $anio)
    {
        ...
        $resultado = $conexion->consultar("SELECT * FROM cirugia WHERE clave = '$claveEsc' AND anio = $anioInt");
        $conexion->cerrar();
    ...
    {
        return $this->conexion->actualizar("TRUNCATE TABLE cirugia");
    }

    public static function contar()
    {
        $conexion = new Conexion();
        $consulta = $conexion->consultarUnaFila('SELECT COUNT(*) AS total FROM cirugia');
