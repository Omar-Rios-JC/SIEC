...
class Urgencia
{
    ...
    public static function listar()
    {
        ...
        $consulta = $conexion->consultar('SELECT * FROM urgencias');
        $conexion->cerrar();
    ...
    public function claveAnioExiste($clave, $anio)
    {
        ...
        $anio = intval($anio);
        $sql = "SELECT COUNT(*) as total FROM urgencias WHERE clave = $clave AND anio = $anio";
    ...
    public function insertarNuevo()
    {
        ...
        $sql = "INSERT INTO urgencias (" . implode(', ', $campos) . ")
    ...
    public function actualizarCamposVacios()
    {
        ...
        $sql = "UPDATE urgencias SET " . implode(", ", $camposUpdate) .
    ...
    {
        $sql = "DELETE FROM urgencias WHERE id = " . intval($this->id);
        return $this->conexion->actualizar($sql);
    }
    ...
    public static function obtenerPorId($id)
    {
        ...
        $listado = $conexion->consultar("SELECT * FROM urgencias WHERE id = $idEscapado");
        $conexion->cerrar();
    ...
    public static function obtenerPorClaveYAnio($clave, $anio)
    {
        ...
        $resultado = $conexion->consultar("SELECT * FROM urgencias WHERE clave = '$claveEsc' AND anio = $anioInt");
        $conexion->cerrar();
    ...
    {
        return $this->conexion->actualizar("TRUNCATE TABLE urgencias");
    }

    public static function contar()
    {
        $conexion = new Conexion();
        $consulta = $conexion->consultarUnaFila('SELECT COUNT(*) AS total FROM urgencias');
