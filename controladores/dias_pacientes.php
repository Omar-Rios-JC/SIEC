...
switch ($accion) {
    case 'Ingresar':
        if (
            ...
            if ($modo === 'insertar' && $urg->claveAnioExiste($urg->clave, $urg->anio)) {
                header('Location: ../vistas/hospitalizacion/ingresar-paciente.php?error=Ya existe esa clave para ese año');
                exit;
            }
            ...
            if ($urg->ingresar()) {
                header('Location: ../vistas/hospitalizacion/pacientes_inicio.php?msg=Operación exitosa');
            } else {
                header('Location: ../vistas/hospitalizacion/pacientes_inicio.php?error=No se realizó ningún cambio');
            }
            exit;
        } else {
            header('Location: ../vistas/hospitalizacion/pacientes_inicio.php?error=Faltan datos');
            exit;
        }
        break;
    ...
    case 'Editar':
        if (!empty($_POST['id'])) {
            ...
            header('Location: ../vistas/hospitalizacion/pacientes_inicio.php?msg=Editado');
            exit;
        }
        break;
    ...
    case 'Eliminar':
        if (!empty($_GET['id'])) {
            ...
            header('Location: ../vistas/hospitalizacion/pacientes_inicio.php?msg=Eliminado');
            exit;
        }
        break;
    ...
    default:
        header('Location: ../vistas/hospitalizacion/pacientes_inicio.php');
        exit;
}
